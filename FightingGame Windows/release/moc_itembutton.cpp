...
QT_MOC_LITERAL(4, 26, 7) // "emitter"

    },
    "ItemButton\0clicked\0\0Item*\0emitter"
};
...
void ItemButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< Item*(*)>(_a[1]))); break;
        case 1: _t->emitter(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ItemButton::*)(Item * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ItemButton::clicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ItemButton::clicked(Item * _t1)
{
